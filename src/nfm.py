...
def nmf_test(nb_tests:int, iter_max:int, tolerance:float)->Tuple[list, list, list, list]:
    ...
    return time_results_implem,time_results_sklearn,distance_results_implem,distance_results_sklearn


nb_tests=100

time_results_implem,time_results_sklearn,distance_results_implem,distance_results_sklearn=nmf_test(nb_tests,200,1e-6)
